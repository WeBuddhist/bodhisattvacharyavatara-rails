...
source_description: |-
  蔣揚仁欽譯師 漢譯。入菩薩行論。
  [English note] This translation appears to be made from the Tibetan version of the text, not from Sanskrit. Confirmed by the presence of verse ^9-140, which corresponds to a verse found in the Tibetan tradition (present in 1-SOURCES/Translations/bo-བློ་ལྡན་ཤེས་རབ།.md) but absent from the Sanskrit root text (1-SOURCES/Text/BCAV08_SH_sk.md), which jumps directly from ^9-139 to ^9-141. Further corroborated by the translator's background: Jamyang Rinchen (蔣揚仁欽) trained in the Gelug tradition at the Dharamshala Debate School and is known primarily as a Tibetan-to-Chinese interpreter (notably for the Dalai Lama's teachings), not as a Sanskritist. Source on translator background: 蔣揚仁欽 – 喇嘛網, https://www.lama.com.tw/content/people/index2.aspx?id=1499
  [English note] Three verses in this translation have no transclusion because no matching verse exists in the root text (1-SOURCES/Translations/bo-བློ་ལྡན་ཤེས་རབ།.md): ^7-62 ("吾寧被燒殺...不行無義事"), ^8-48 ("昔衣汝亦貪...何故擁著衣"), and ^8-186 ("如佛大悲子...何日得出苦"). This has a knock-on effect on this file's own numbering: after each of these three points, every subsequent verse in that chapter is one number ahead of the root verse it actually translates (e.g. this file's ^7-63 translates the root's ^7-62, and so on through ^7-76 translating root ^7-75; likewise for chapters 3 and 8). The transclusion link placed before each verse in the body of this file gives the correct root correspondence — go by that link, not by matching verse numbers.
source: https://webuddhist.com/
license: cc0
category_id: JD5ULLPAV1cxg7RSb7L3q
text_id: 2eOLbtshG8DUqet91I5wc
edition_id: UeXaNlPycKnnUpTnyXnas
toc_id: a8YYKeutqcyzLZQ7j3LID
---
