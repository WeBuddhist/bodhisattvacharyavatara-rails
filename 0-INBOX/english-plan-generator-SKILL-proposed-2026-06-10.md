...
> **PROPOSED REVISION — for human review before committing into `4-SYSTEM/Skills/`.**
> Drafted 2026-06-10. Folds in the Day 2 tester feedback and the editorial direction agreed during Day 12 drafting. Net changes: A2 reading level, a narrated second-person voice, rich-text formatting now allowed and encouraged, plain-language helper line under each section, a tightened single-action practice challenge, an em-dash ban in prose, and guidance for producing comparison options. See the Revision history at the bottom for the full list. Delete this blockquote when committing.
