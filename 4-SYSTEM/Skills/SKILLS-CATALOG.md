...
**Inputs:** Verse ID (e.g. `1-1`); commentary files in `1-SOURCES/Commentaries/Transcluded/`; Khenpo Zhenga's mchan-'grel at `1-SOURCES/Commentaries/bo-མཁན་པོ་གཞན་དགའ།.md`.
