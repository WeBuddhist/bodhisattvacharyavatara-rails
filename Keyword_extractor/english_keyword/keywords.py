...
Default source (edit SOURCE_PATH to change):
    sanskrit-english/bca-english-plain-zeroshot.md

Output is written next to this script, e.g.:
    output/bca-english-plain-zeroshot-raw.json
    output/bca-english-plain-zeroshot-keywords.md
    output/bca-english-plain-zeroshot-preview.md
"""
