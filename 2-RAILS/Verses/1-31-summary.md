...
notes: |
  Grouping matrix:
  - KKP (kunpal): unique prose for 1-31.
  - KS (khenpo-zhengah): unique mchan for 1-31; interlinear annotation.
  - GDR (gyaltsab): unique prose for 1-31; new section heading marks a transition in the commentary.
  - NTS (ngulchu-thogmed): unique prose for 1-31.
  - SMPLG (sabzang): unique prose for 1-31.
  - MKS (minyak-kunzang-sonam): unique prose for 1-31.
  - NKW (khenpo-kunga): unique prose for 1-31.
  All citations are file-level; no block IDs.
---

# སྤྱོད་འཇུག ༡།༣༡པའི་ཤོག་ངོས།
