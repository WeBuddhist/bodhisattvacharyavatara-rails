...
status: draft
option: A
angle: "Great merit, little effort — a small offering, stretched across space in the mind"
generation_note: "No en-ai or 2-RAILS material exists for Chapter 2. English verses from 1-SOURCES/Translations/en-David_Karma_Choephel.md (^2-4, ^2-5). Commentary grounded in the Tibetan source bo-དངུལ་ཆུ་ཐོགས་མེད།.md (offering to the limits of space, perfecting merit with little hardship), via the Tibetan plan (bo/Chapter-2 D15-D40/Day-16-Ch2-V4-5.md). Interim; needs domain-specialist review before status: complete."
---

# Day 16 — A small offering, as wide as space

> **Notification**
> **Title:** Offer something beautiful, and let it grow
> **Detail:** The offering continues. Today, picture something beautiful, stretch it as wide as you can, and offer it in your mind.

## Opening

Yesterday the offering began with the beauty of this world. Today it grows far larger. Shantideva offers even the riches of the heavens, beautiful lakes with lotuses and singing swans, every lovely thing there is. He owns none of it, and gives it all to the buddhas.
