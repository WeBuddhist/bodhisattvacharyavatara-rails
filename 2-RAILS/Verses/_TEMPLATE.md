...
<!-- HOW TO USE: copy this file to <ref>.md (e.g. 1-1.md). Fill every section.
 REQUIRED sections (never delete): Source Text, Traditional Interpretation, AI Overview,
 Disambiguated Restatement. OPTIONAL sections (delete the heading if no cited material
...
## 3. AI Overview (བསྡུས་དོན།)

**ངོ་སྤྲོད་མདོར་བསྡུས།** <one–two Tibetan sentences answering "what does this verse say," in a single synthetic voice.>
(1-SOURCES/Commentaries/<file>.md#^<block>)
...
## 5. Word-by-word Disambiguation (ཚིག་དོན་གསལ་བཤད།)
...
## 6. Key Concepts (ཆོས་ཀྱི་གནད་ཚིག)
...
## 10. Disambiguated Restatement (Tibetan)
