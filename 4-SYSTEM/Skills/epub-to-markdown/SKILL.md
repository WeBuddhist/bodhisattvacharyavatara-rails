...
description: Extract content and structure from EPUB files into clean Markdown without methodology-specific formatting. Use for initial ingestion of source materials.
---
