...
-------
  output/idf_corpus.pkl   — pickled dict[str, float]  (fast load at runtime)
  output/idf_corpus.py    — Python module exporting IDF_CORPUS: dict[str, float]
...
OUT_PKL = OUTPUT_DIR / "idf_corpus.pkl"
OUT_PY  = OUTPUT_DIR / "idf_corpus.py"
