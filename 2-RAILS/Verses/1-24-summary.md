...
notes: |
  Grouping matrix:
  - KKP (kunpal): unique prose for 1-24.
  - KS (khenpo-zhengah): unique mchan for 1-24; no scripture quotation in KS annotation for this verse.
  - GDR (gyaltsab): unique prose for 1-24.
  - NTS (ngulchu-thogmed): 1-23, 1-24, and 1-25 grouped; 1-24 is NOT first verse → cross-reference 1-23-summary.md for full grouped prose.
  - SMPLG (sabzang): unique prose for 1-24; includes MSA quotation (placed in ལུང། here).
  - MKS (minyak-kunzang-sonam): 1-23 and 1-24 grouped; 1-24 is NOT first verse → cross-reference 1-23-summary.md. The MSA quotation in MKS appears in the 1-23 anchor prose (1-23-summary.md → ལུང།).
  - NKW (khenpo-kunga): unique prose for 1-24.
  Mahāyānasūtrālaṃkāra quotation: SMPLG places it in 1-24 prose (unique to 1-24 here); NTS and MKS place it in their 1-23-anchored grouped prose (see 1-23-summary.md → ལུང།).
  All citations are file-level; no block IDs.
---

# སྤྱོད་འཇུག ༡།༢༤པའི་ཤོག་ངོས།
