...
translation_note: >-
  English translation of the companion source-of-truth file `6.md`. All
  Tibetan rail content (interlinear gloss, commentary explanations,
  ...
  references are preserved as they stand in the source file (inline
  `([[...]])`); consolidation into per-section `Sources:` lines and anchor
  insertion are left to the later `conform` pass. The original
  Tibetan/Sanskrit remains the authoritative record in `6.md`; where a term's
  mapping matters (Key Terms, metaphors) the original Tibetan is kept in
  ...
  bodhisattva, arhat, samsara, Great Vehicle, etc.). Draft — needs
  domain-specialist review; ⚑ items flag uncertain proper nouns.
translated_from: "3-TRANSFORMATIONS/Day-Packages/bo/Chapter-1 D1-D14/6.md"
sources:
...
The **aspiring mind**: (a) merely wishing for awakening as a future result (phala) — desiring the state of a bodhisattva (and the happiness of gods, humans, and so on). The **engaging mind**: (b) aspiring toward the cause (hetu) — the path, the two accumulations — and, having taken up the vow, entering into it. (Important:) Minyak Kunzang Sonam clarifies that Khenpo Zhenga's word "itself/only" (nyid — "these two only") means exactly these two, and no others.
...
The **aspiring mind** — oriented toward the result: making the aspiration-prayer to establish all beings in the great, perfect awakening (buddhahood), while not yet entering into the accumulations of the path (the perfections).

The **engaging mind** — oriented toward the cause: once the aspiring mind has arisen before it, taking up the vow (received, per Khenpo Kunga, through Atiśa's ritual method — the actual ritual liturgy) and actually entering into the two accumulations.
...
###### 1. The Division of Bodhicitta Into Two

In brief, there are two: the aspiring mind (praṇidhicitta) and the engaging mind (prasthānacitta / bodhiprasthāna). All the commentaries agree on this.

###### 2. "Itself" = These Two Alone

Khenpo Zhenga's annotation clarifies that "by the word 'itself,' the meaning is these two alone" (nyid as an exclusion particle), and Minyak Kunzang Sonam agrees.

###### 3. The Aspiring Mind Is Oriented Toward the Result; The Engaging Mind Toward the Cause

(Minyak Kunzang Sonam / Khenpo Kunga) The aspiring mind aspires to the state of perfect awakening (the result / buddhahood); the engaging mind enters into the two accumulations (the perfections) — that is, oriented toward the cause, the path.

###### 4. The Engaging Mind Requires Taking Up the Vow

(Gyaltsab / Sabzang / Khenpo Kunga) "Having taken up the vow" (vrata / ādarśa-bhūta / śīla-saṃvara) is shown, following Atiśa, to be taken up gradually through the ritual method.

###### 5. Khenpo Kunga: Six Sub-Types

The aspiring mind (alone / by ritual / non-degenerating = three) plus the engaging mind (alone / by ritual / non-degenerating = three) make six sub-types in total. (Twenty-two classifications exist, but here it is brief — "in short.")
...
|---|---|---|
| **Aspiring mind** (སྨོན་སེམས། / smon sems / *praṇidhicitta*) | Aspiring to establish all beings in the great, perfect awakening (wishing / *icchā*), without yet entering the accumulations of the path — the awakening mind oriented toward the result. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-15]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-15]]) |
| **Engaging mind** (འཇུག་སེམས། / 'jug sems / *bodhiprasthānacitta*) | Once the aspiring mind has arisen before it, having taken up the vow (*vrata*), entering into the two accumulations (the perfections) — the awakening mind oriented toward the cause. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-15]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-15]]) |
| **Itself / only** (ཉིད་ / nyid / *eva*) | "These two alone" — an exclusion particle; no others are included. (Clarified in Khenpo Zhenga's annotation.) | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-15]]) |
| **Taking up the vow** (སྡོམ་པ་བླང་བ། / sdom pa blang ba) | When adopting the engaging mind one must take up the vow — Atiśa's ritual. Without taking it, one has only the aspiring mind; having taken it, one has the engaging mind. | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-15]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC14_SMPLG_bo_segmented.md#^1-15]]) |
...
- **gyaltsab, ngulchu-thogmed, sabzang, minyak-kunzang-sonam, khenpo-kunga** ⚑: All of them settle the matter as [committing oneself] to the result being the aspiring mind and [committing oneself] to the causal path being the engaging mind; they do not lay it out in terms of the stages of the path of accumulation, the path of joining, their union, and so on.
...
###### 1. The Example of Wishing to Go and Actually Going

The verse clarifies the aspiring and engaging minds as distinct by mapping them onto two cases: the mind wishing to go to a place, and actually setting out on the road and traveling. Though in both the intention "I shall attain buddhahood for the sake of others" is one and the same, they differ in whether or not one is engaged in the act of practice — generosity and the rest.

###### 2. The Difference Between Focusing on the Result and Focusing on the Causal Path

Although many scholars are said to hold differing views on how to demarcate these two, most traditions agree that not being engaged in the act [of practice] is the aspiring mind and being engaged in it is the engaging mind.

###### 3. Two Methods of Meditation: The Exchange of Self and Other, and the Sevenfold Cause-and-Effect Instruction
...
###### 4. The Aspiring Mind Outshines the Qualities of the Shravakas

Even without having entered the path, and even when unable [to practice] the perfections, merely generating the aspiring mind means one does not lose the name "bodhisattva" and outshines the qualities of the shravakas and pratyekabuddhas — as taught in the *Account of Maitreya's Liberation*.
...
| Term | Commentary definition | Source |
|---|---|---|
| **Wishing to go** (འགྲོ་བར་འདོད་) | Wishing to go, in order to reach a longed-for place — the mere intention, not yet engaged in the act of the path. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-16]]) |
| **Going** (འགྲོ་བ་) | Actually traveling, engaged in the act of the path — lifting and setting down the feet and so on. | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-16]]) |
| **The wise** (མཁས་པ་) | The wise bodhisattvas; persons who realize the true nature of what is knowable without error. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KKP_bo_segmented.md#^1-16]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC14_SMPLG_bo_segmented.md#^1-16]]) |
| **Step by step** (རིམ་བཞིན་) | In the proper sequence: the aspiring mind first, the engaging mind after. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-16]]) |
| **Exchange of self and other** (བདག་གཞན་མཉམ་བརྗེ།) | The pith instruction of equalizing and exchanging self and other; here held to be the chief method of cultivating bodhicitta in this text. Though profound and of great power, it carries a risk of confusion for some meditators. | ([[1-SOURCES/Commentaries/Transcluded/BCAC20_TG_bo.toc.md#^1-16]]) |
| **Sevenfold cause-and-effect instruction** (རྒྱུ་འབྲས་མན་ངག་བདུན་མ།) | Another method of cultivating bodhicitta, drawn from the Stages of the Path (Lamrim) tradition and distinct from the exchange of self and other; said to suit the character of some meditators. | ([[1-SOURCES/Commentaries/Transcluded/BCAC20_TG_bo.toc.md#^1-16]]) |
...
- **His Holiness the Dalai Lama** — The Bodhicaryāvatāra chiefly teaches the cultivation of bodhicitta through the exchange of self and other; the sevenfold cause-and-effect instruction is explained as an alternative method, and one is advised to meditate in accordance with one's own character.
