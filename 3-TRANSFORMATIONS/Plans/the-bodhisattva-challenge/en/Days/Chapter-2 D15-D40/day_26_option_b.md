...
status: draft
option: B
angle: "Real confession includes the turn not to repeat it — admitting is only half; the resolve to restrain from now on is the other half; lead on Sazang Mati Panchen"
generation_note: "No en-ai or 2-RAILS material exists for Chapter 2. English verses from 1-SOURCES/Translations/en-David_Karma_Choephel.md (^2-28, ^2-29). Tibetan verses from 1-SOURCES/Translations/bo-བློ་ལྡན་ཤེས་རབ།.md (^2-28, ^2-29). From the Tradition grounded in Sazang Mati Panchen (bo-ས་བཟང་མ་ཏི་པཎ་ཆེན་བློ་གྲོས་རྒྱལ་མཚན།-tsadra.md, gloss on ^2-28/29): confessing to the protectors of beings from the depths of the heart, with the explicit added clause སླན་ཆད་ཀྱང་སྡོམ་པར་བགྱིད — and committing to restrain from such acts from now on. Benefits (recognizing one's deeds leads to conscientiousness/apramada; confessing with remorse pacifies the mind's burden and gives strength to engage virtue) from the user-provided English translation of the Tibetan plan (bo/Chapter-2 D15-D40, Day 26, Ch2 V28-29). Interim; needs domain-specialist review before status: complete."
---

# Day 26 — Confession that faces forward

> **Notification**
> **Title:** Admit one wrong, and quietly resolve not to repeat it
> **Detail:** Today's verses confess past wrongs, and the commentary adds the turn that makes it real.
...
It is easy to say sorry for something and then do the same thing next week. Sazang Mati Panchen, a fourteenth-century teacher, adds a small clause that changes what confession is for: after the admitting, you also commit to restrain yourself from now on. So confession has two halves. One faces back, naming what you did. The other faces forward, resolving not to walk the same way again. Without the second half nothing has actually changed, and the weight on your mind does not lift.
...
Bring to mind one thing you would rather not repeat. Admit it simply to the buddhas and bodhisattvas, then make one plain resolve for the next time it comes around. Small and specific is enough.
