...
| `4-SYSTEM/docs/vault-annex.md` | Vault-specific addressing scheme, commentary IDs, language tracks |
...
| `4-SYSTEM/docs/0-VAULT-Structure.md` | Generic architecture doc |
| `4-SYSTEM/docs/why-rails.md` | Generic methodology doc |
| `4-SYSTEM/docs/skills-system.md` | Generic skills discovery doc |
...
| `4-SYSTEM/docs/` (how-to guides) | Generic how-to docs (setup, sync, git) |
