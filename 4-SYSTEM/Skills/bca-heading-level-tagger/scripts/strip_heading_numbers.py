...
(`## N. ...`) to know which chapter each Obsidian Block ID belongs to -- so the
...
- Top-level `## N. ...` chapter headings keep their number. It reads as a
  ...
  stripped it, a future re-run of the Obsidian Block ID step on this file would no
...
- Any Obsidian Block ID (`^1-0`, `^I-0`, `^6-42`, ...) on a heading line -- these
