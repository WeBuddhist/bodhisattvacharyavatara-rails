...
translation_note: >-
  English translation of the companion source-of-truth file `5.md`. All
  ...
  authoritative record in `5.md`; where a term's mapping matters (Key Terms,
...
translated_from: "3-TRANSFORMATIONS/Day-Packages/Chapter-1 D1-D14/5.md"
sources:
...
###### 1. The Point of the Two Examples, the Banana Tree and the [Wish-Granting] Tree

All other virtue (*chu shing* = *kadalī*) gives fruit once and is then spent; bodhicitta (*ljon shing* = *kalpataru*) yields it constantly and is inexhaustible. All commentaries agree on this position.

###### 2. The Three Names of the [Wish-Granting] Tree

(**NKW**) (a) *dpag bsam gyi shing* (*kalpataru*), (b) *lha'i yul gyi sa brtol*, (c) *'dzam bu pakṣa* — all three are used as images of that which is inexhaustible and yields fruit without end.

###### 3. The Distinctive Feature of the Inexhaustible Root of Virtue

(**MKS**) bodhicitta yields happiness to a person in life after life, birth as a god or human; it also leads to the state of buddhahood (the three kāyas) and is inexhaustible; it is not exhausted even by karma that is certain to be experienced.

###### 4. Shlokas 1-10 / 1-11 / 1-12 Taken Together Within a Single Annotation-Node

(**KKP**) Khenpo Kunzang did not divide out an occasional annotation-node but placed the three together. He gives the explanation from annotation-node 1-10, and 1-11 and 1-12 belong to the portion of that single node.

###### 5. Inexhaustible Even After Buddhahood Is Attained

Tenzin Gyatso adds a distinct point: bodhicitta-bound virtue does not merely continue growing on the path toward buddhahood — even once full enlightenment is actualized, the mind that is imbued with bodhicitta continues to accomplish others' welfare without limit (space itself is not exhausted), so the good qualities born from it do not become exhausted even after buddhahood is attained.
...
|---|---|---|
| **Banana tree** (*chu shing* / kadalī / banana tree) | Gives fruit once and is then spent. All other virtue is likened to it here. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-12]]) |
| **The [wish-granting] tree** (*ljon shing* / *dpag bsam gyi shing* / kalpataru) | Yields fruit constantly and is inexhaustible. The root of virtue dedicated by bodhicitta is inexhaustible until it reaches the essence of awakening. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-12]]) |
| **Inexhaustible** (*mi zad* / inexhaustible) | A benefit of bodhicitta — having yielded the fruit that is certain to be experienced, it is not exhausted; it grows more and more. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-12]]) |
| **Essence of awakening** (*byang chub snying po*) | The root of awakening — [virtue] increases inexhaustibly until it reaches it. (From the *Akṣayamati-paripṛcchā*.) | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-12]]) |
...
- **His Holiness the Dalai Lama** adds a further point: even after the state of complete awakening is actualized, virtue embraced by bodhicitta comes to be inexhaustible.
...
###### 1. Bodhicitta = The Exhauster of Non-Virtue

Even if one has committed [deeds] like the five of immediate retribution, by relying on bodhicitta one is freed in a single instant. All commentaries agree on this position.

###### 2. The Distinction Between 1-13 and 1-14 Is Important

(**GDR** and **MKS**) — 1-13 = *zil gyis gnon pa* (sudden suppression; the karma that is certain to be experienced [*myong nges kyi las*] is not exhausted [but suppressed]); 1-14 = *rtsa ba nas 'joms pa* (uprooting; uncertain karma is uprooted from the root).

###### 3. Settling the Point by Its Converse

"**why would the careful not rely on it?**" (*de la bag yod can rnams kyis cis mi bsten*) — settling the matter in the manner of the [scriptural] explanation. The root text presents it, and all commentaries agree on this position.

###### 4. The Converse of "Ignorant People"

(**SMPLG** / **MKS**) — in the root shloka appears "**why would ignorant people not rely on it?**" (*mi shes kye bo* / *kim u momuḥ*), showing that even one who has done utterly unbearable wrong may rightly rely on it.
...
| Term | Commentary definition | Source |
|---|---|---|
| **The deeds of immediate retribution** (*mtshams med* / ānantarya) | The five unbearable evil deeds: killing one's father [or mother], killing a monk, drawing blood from the body of a buddha, and creating a schism in the sangha. | ([[1-SOURCES/Commentaries/Transcluded/BCAC20_NKW_bo_segmented.md#^1-13]]) |
| **A brave man** (*skyes bu dpa' bo* / brave warrior) | Just as elsewhere a powerful man makes one unafraid, so [bodhicitta] is likened to him. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-13]]) |
| **Freed in a single instant** (*skad cig gcig gis sgrol*) | By relying on bodhicitta one is freed swiftly, in a single instant. (It denotes an instant of time, not a proper name.) | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-13]]) |
| **Suppression** (*zil gyis gnon pa*) | The method of bodhicitta in 1-13: it suddenly suppresses karma certain to be experienced (*myong nges kyi las*); it does not uproot it from the root. (Distinguished from 1-14.) | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-13]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-13]]) |
...
**(First two lines) The fire example** — whereas **1-13** *suppresses* karma that is certain to be experienced (*myong nges kyi las*), **1-14** *uproots* uncertain [karma] (*ma nges pa'i las ngan*). Like the fire at the end of an age, in the single instant of a bodhisattva's attaining great forbearance (*mahākṣānti*), all uncertain karma is burned and uprooted from the root.
...
**(First two lines)** Bodhicitta (like the fire at the end of an age = the fire of seven suns = that which burns everything up through the first meditative-absorption realm) burns, in a single instant, all the great wrongdoing that has become a cause of the lower realms (*apāya-hetu*). *(NTS has a tenet-annotation clarifying the age-ending fire as "the fire of seven suns.")*
...
**(First two lines) The fire example** — in "the instant of attaining great forbearance" (*bzod chen thob pa'i skad cig* — SMPLG's specific formula), bodhicitta burns (*dagdha*) from the root all uncertain (*aniyata*) evil karma. The age-ending fire = **the fire of seven suns** (a cosmological fire of seven suns), which, with none of the four [masses] remaining, burns everything up through the first meditative-absorption realm.
...
**(First two lines) The fire example.** Bodhicitta uproots from the root uncertain (*aniyata*) evil karma (bad karma) — not karma certain to be experienced (*myong nges kyi las*). **Important:** MKS agrees with Gyaltsab — the distinction between (a) *suppressing* karma certain to be experienced (1-13) and (b) *uprooting* uncertain evil karma from the root (1-14) is made clear — and the *Śikṣāsamuccaya* is cited on "the increase of merit" (*bsod nams 'phel ba*). *(MKS also cites: from the *Gaṇḍavyūha*, a passage arose — "all non-virtuous states are destroyed [by bodhicitta] as if beneath the earth.")*
...
**(First two lines) The fire example** — just as the fire of seven suns (NKW) burns everything up through the first meditative-absorption realm (up to the form realm, *rūpadhātu*), so bodhicitta burns, in a single instant, all uncertain evil karma (that has become a cause of the lower realms).
...
###### 1. The Two Parts of This Shloka

(a) The first two lines = **the fire example** (*kalpāntānala*): bodhicitta burns uncertain karma. (b) The last two lines = **the loving protector's teaching of the boundless qualities** (*Gaṇḍavyūha*). All commentaries agree on this position.

###### 2. The 1-13 vs. 1-14 Distinction Is Important

(**GDR / MKS**) — 1-13 = *zil gyis gnon pa* (suppressing the karma certain to be experienced); 1-14 = *rtsa ba nas 'joms pa* (uprooting uncertain karma from the root).

###### 3. The Instant of Attaining Great Forbearance

(**SMPLG**) SMPLG's tenet-annotation makes clear that bodhicitta's uprooting of uncertain karma from the root occurs in "the instant of attaining great forbearance" (*bzod chen thob pa'i skad cig* / *mahākṣānti*).

###### 4. The Age-Ending Fire = The Fire of Seven Suns

(**NTS / NKW**) — a tenet-term making clear that it burns everything up through the first meditative-absorption realm (the intermediate realm).

###### 5. Even an Ordinary Person Can Generate Bodhicitta

His Holiness the Dalai Lama, citing the *Śikṣāsamuccaya*, explains that this beneficial mind can be generated even by an ordinary person; that generating it does not require directly seeing the truth or directly seeing emptiness; and that, without distinction of male or female, family or lineage, any being who meditates and makes effort can generate it. By this he shows the qualities of both aspiration and engagement bodhicitta without separating them.
...
| Term | Commentary definition | Source |
|---|---|---|
| **The fire at the end of an age** (*dus mtha'i me* / *kalpāntānala*) | At the end of an age, the fire of seven suns burns everything up through the first meditative-absorption realm. A cosmological fire, in the tenets. | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_NTS_bo_segmented.md#^1-14]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC20_NKW_bo_segmented.md#^1-14]]) |
| **Uncertain karma** (*ma nges pa'i las* / *aniyata-karma*) | The main [target] in 1-14: karma not certain to be experienced. Bodhicitta uproots it from the root. (Distinguished from *myong nges kyi las* in 1-13.) | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-14]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-14]]) |
| **The loving protector** (*byams mgon* / Maitreya) | The Bodhisattva Maitreya, who explained the boundless qualities of bodhicitta to (Sudhana) from the *Gaṇḍavyūha*. | ([[1-SOURCES/Commentaries/Transcluded/BCAC19_KS_bo.md#^1-14]]) |
| **Sudhana** (*nor bzang* / Sudhana) | The youth Sudhana — the chief pilgrim-student in the *Gaṇḍavyūha Sūtra*. The loving protector explained the qualities of bodhicitta to him there. | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-14]]) |
| **Uprooting from the root** (*rtsa ba nas 'joms pa*) | The method of bodhicitta in 1-14: uncertain karma is uprooted from the root. Distinguished from the *suppression* (*zil gyis gnon*) of 1-13. | ([[1-SOURCES/Commentaries/Transcluded/BCAC14_GDR_bo_segmented.md#^1-14]]) ([[1-SOURCES/Commentaries/Transcluded/BCAC19_MKS_bo_segmented.md#^1-14]]) |
...
- **His Holiness the Dalai Lama** — citing the *Śikṣāsamuccaya*, explains that even an ordinary person can generate bodhicitta, and that it can be generated through effort, without needing to directly see the truth and without distinction of male or female, family or lineage.
