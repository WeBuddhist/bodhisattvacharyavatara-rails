...
`3-TRANSFORMATIONS/Day-Packages/bo/`.
...
- **Tibetan source packages** (source-of-record): `Day-Packages/bo/Chapter-<N> D<first>-D<last>/<day>.md`
- **English translations**: `Day-Packages/en/Chapter-<N> D<first>-D<last>/<day>-en.md`

e.g. `Day-Packages/bo/Chapter-1 D1-D14/1.md` (Tibetan) → `Day-Packages/en/Chapter-1 D1-D14/1-en.md` (English).

Shared docs (`_TEMPLATE.md`, `_TERMBASE.md`) live in `Day-Packages/bo/`.
